...
*/
class Lambdasian {
  //we have to include the {} within constructor which differs than prior examples, as we are adding 1 object with values, whereas the constructor took multiple objects
